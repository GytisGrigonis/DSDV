...
namespace DSDV
{
    public class RoutingTable
    {
        ...
        public void PrintTable()
        {
            ...
            Console.WriteLine("Dest" + "  " + "Next" + "  " + "NumH" + "  " + "SeqN" + "     " + "InsT");
        ...
        public bool newLink(Router router)
        {
            ...
            foreach(var neigh in router.Neighbors)
            {
        ...
        {
            var brokenLinks = _routingTableLines.FindAll
                (x => x.Destination != OwnLine().Destination && 
                (_ownRoutingTableLines[x] < time -  updateSeconds * 3) && !x.SequenceNumber.IsOdd());
        ...
        public void BrokenLink(RoutingTable receivedTable)
        {
            ...
            foreach (var line in receivedTable._routingTableLines)
            {
                ...
                {
                    var toChange = _routingTableLines.Find(x => x.Destination == line.Destination 
                    && x.NextHop == infoLine.Destination);
                    if (toChange != null)
                    {
